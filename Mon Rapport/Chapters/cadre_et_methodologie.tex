...
\[
x' = \frac{\text{min} - x}{\text{min} - T(x)} \times 100
\]

où $x$ est la valeur observée, $\text{min}$ la borne inférieure, $T(x)$ la cible 2030, et $x'$ la valeur normalisée sur l’échelle 0--100.

\begin{remark}
Notons que ce qui est appelé minimum (min) correspond à la valeur la plus inadéquate pour un indicateur donné : Pour la pauvreté celle ci sera plus grande que la cible car la pauvreté est censée baisser.
\end{remark}
...
Après pondération, les indicateurs sont combinés en utilisant la moyenne arithmétique pour obtenir un score par ODD.
