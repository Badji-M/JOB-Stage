...
\def\@makechapterhead#1{%
	...
	\node at (current page.north west) {
		...
		align=left,
		color=myblue,
		text width=0.7\textwidth % Limite la largeur du texte
...
\node at (current page.north west) {
	...
	% Titre à droite (même logique)
	\node[
	anchor=west,
	align=left,
	color=myblue,
	text width=0.7\textwidth % Limite la largeur aussi
	] at ([xshift=1cm]chapnum.east) {
		\huge\sffamily\bfseries #1
	};
