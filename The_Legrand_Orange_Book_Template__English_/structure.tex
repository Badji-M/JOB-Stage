...
\usepackage{tocloft} % Customize table of contents, lists of figures and tables
...
%----------------------------------------------------------------------------------------
%	MEEEEEEEEEEE  POUR LES SECTIONS .
%----------------------------------------------------------------------------------------
\usepackage{titlesec}
...
\def\@makechapterhead#1{%
	...
	\node at (current page.north west) {
		...
		% Titre à droite du carré (avec retour à la ligne automatique)
		\node[
		anchor=west,
		align=left,
		color=myblue,
		text width=0.9\textwidth % Limite la largeur du texte
...
\node at (current page.north west) {
	...
	% Titre avec trait bleu en dessous
	\node[
	anchor=north west,
	align=left,
	color=myblue,
	text width=0.85\textwidth
	] (schaptitle) at (2cm,-5cm) {
		\LARGE\sffamily\bfseries\linespread{1.3}\selectfont #1
	};
	
	% Trait bleu horizontal sous le titre
	\draw[line width=2pt, color=myblue] (2cm, -6.5cm) -- (\paperwidth-2cm, -6.5cm);
...
\draw[anchor=west] (\Gm@lmargin,-9cm) node [line width=2pt,rounded corners=15pt,draw=myblue,fill=white,fill opacity=0.5,inner sep=15pt]{\strut\makebox[22cm]{}};
